...
const fastGPT = new FastGPT(
  "fastgpt-s7ccOtIJRjm5GusMW9utanyDQecWjuhherYKsm71nvJ0ZqdZyhg8FBCrHc1fg1t7"
);
      ...
      <div class="card-content">
        ...
        <div class="content-section">
          ...
          <div class="section-body">
            <div
              v-if="questionsData.questionContent"
              v-html="marked(questionsData.questionContent)"
            ></div>
          </div>
        </div>
        ...
        >
          ...
          <div class="ai-content markdown-body">
            ...
            <el-alert
              ...
              :title="
                answerValidity ? '回答正确！' : '回答错误，请查看反馈并修改。'
              "
